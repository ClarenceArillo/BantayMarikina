...
const DATE_OPTIONS: Array<{ label: string; value: ReportDateFilter }> = [
  ...
  return (
    <View style={[styles.container, compact ? styles.compactContainer : null]}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.row}>
        ...
        <Pressable style={[styles.resetButton, { borderColor: theme.border }]} onPress={() => onChange({ dateRange: 'month', hazardType: 'All', severity: 'All', status: 'All', source: 'All' })}>
